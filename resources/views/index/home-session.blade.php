    ...
    let stories = new Zuck('stories', {
        ...
        stories: [
            ...
            @foreach($stories as $story) {
                ...
                }, // last updated date in unix time format
                ...
                items: [
                    ...
                    @foreach($story -> media() -> get() as $media) {
                        ...
                        length: {
                            {
                                $media -> type == 'photo' ? 5 : ($media -> video_length ? : $settings -> story_max_videos_length)
                            }
                        }, // photo timeout or video length in seconds - uses 3 seconds timeout for images if not set
                        ...
                        }, // optional a date to display with the story item. unix timestamp are converted to "time ago" format
