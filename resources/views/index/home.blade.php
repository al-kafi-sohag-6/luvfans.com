...
@section('content')
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-5 second">
          <h1 style="font-size: 2.1em;" class="display-4 pt-1 mb-3 text-white text-center-sm">{{trans('general.welcome_title')}}</h1>
  ...
  <div class="section py-5 py-large">
    <div class="container">
		<!-- LAUNCH SPECIAL -->
        <div style="display: block; width: 100%; text-align: center; margin-bottom: 5px; background-color: red; color: white; border-radius: 10px;" class="btn-block text-center mb-5">
          <h2 class="txt-white">{{trans('general.launch_special_h')}}</h2>
          <p>
  ...
  <div class="section py-5 py-large">
    <div class="container">
      ...
      <div class="col-12 col-lg-5">
        <h2 class="m-0 card-profile txt-black">{{trans('general.header_box_3')}}</h2>
...
@if ($settings->widget_creators_featured == 'on')
    ...
    <div class="section py-5 py-large">
      <div class="container">
        <div class="btn-block text-center mb-5">
          <h2 class="txt-black">{{trans('general.creators_featured')}}</h2>
          <p>
...
<div class="section py-5 py-large">
  <div class="container mb-4">
    <div class="btn-block text-center">
      <h2 class="txt-black">{{trans('general.earnings_simulator')}}</h2>
      <p>
