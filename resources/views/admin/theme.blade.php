            ...
            <div class="card shadow-custom border-0">
                <div class="card-body p-lg-5">
                    ...
                    <form method="post" action="{{{ url('panel/admin/theme') }}}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-4">
                            <label class="col-sm-2 col-form-label text-lg-end">{{ __('general.category_default') }}</label>
                            <div class="col-lg-5 col-sm-10">
                                <div class="d-block mb-2">
                                    <div style="max-width: 150px; height: 150px; margin-bottom: 10px; display: block; border-radius: 6px; background: #505050 @if ($settings->category_default) url('{{ Helper::getFile(config('path.category_default').$settings->category_default) }}') no-repeat center center; background-size: cover; @endif ;">
                                    </div>

                                    <div class="input-group mb-1">
                                        <input name="category_default" type="file" class="form-control custom-file rounded-pill">
                                    </div>
