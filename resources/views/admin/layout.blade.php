        ...
        <div class="offcanvas offcanvas-start sidebar bg-dark text-white" tabindex="-1" id="sidebar-nav" data-bs-keyboard="false" data-bs-backdrop="false">
            ...
            <div class="offcanvas-body px-0 scrollbar">
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start list-sidebar" id="menu">
                    ...
                    <li class="nav-item">
                        <a href="#settings" data-bs-toggle="collapse" class="nav-link text-truncate dropdown-toggle @if (request()->is('panel/admin/settings') || request()->is('panel/admin/settings/limits') || request()->is('panel/admin/settings/restrictions') ) active @endif" @if (request()->is('panel/admin/settings') || request()->is('panel/admin/settings/limits') || request()->is('panel/admin/settings/restrictions') ) aria-expanded="true" @endif>
                            <i class="bi-gear me-2"></i> {{ __('admin.general_settings') }}
                        </a>
                    </li><!-- /end list -->
                    @endif

                    <div class="collapse w-100 @if (request()->is('panel/admin/settings') || request()->is('panel/admin/settings/limits') || request()->is('panel/admin/settings/restrictions')) show @endif ps-3" id="settings">
                        <li>
                        ...
                        <li>
                            <a class="nav-link text-truncate @if (request()->is('panel/admin/settings/restrictions')) text-white @endif" href="{{ url('panel/admin/settings/restrictions') }}">
                                <i class="bi-chevron-right fs-7 me-1"></i> {{ trans('admin.restrictions') }}
                            </a>
                        </li>
