            ...
            <div class="row mb-3">
                  ...
                  @for ($i=1; $i <= 50; ++$i)
                    ...
                    @endfor
						...
						<div class="row mb-3">
 							<label class="col-sm-2 col-form-label text-lg-end">Custom referral (in percent)</label>
 							<div class="col-sm-10">
 								<input value="{{ $user->custom_refer }}" name="custom_refer" type="number" class="form-control isNumber" autocomplete="off">
 							</div>
 						</div>
					
					<fieldset class="row mb-4">
					 <legend class="col-form-label col-sm-2 pt-0 text-lg-end">Referral</legend>
					 <div class="col-sm-10">
					   <div class="form-check form-switch form-switch-md">
						<input class="form-check-input" type="checkbox" name="referral" @if($user->referral == 1) checked @endif value="1" role="switch">
					  </div>
					 </div>
				   </fieldset>
