...
<h5 class="mb-4 fw-light">
    ...
    <a class="text-reset" href="{{ url('panel/admin/sub-categories') }}">Sub Categories</a>
    <i class="bi-chevron-right me-1 fs-6"></i>
        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow-custom border-0">
                <div class="card-body p-lg-5">
                    ...
                    <form method="post" action="{{ url('panel/admin/sub-categories/update') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input value="{{ $sub_categories->name }}" name="name" type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input value="{{ $sub_categories->slug }}" name="slug" type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input value="{{ $sub_categories->keywords }}" name="keywords" type="text" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="description" rows="4">{{ $sub_categories->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-5 col-sm-10">
                                <div style="max-width: 150px; height: 150px; margin-bottom: 10px; display: block; border-radius: 6px; background: #505050 @if ($sub_categories->image) url('{{ Helper::getFile(config('path.sub_category').$sub_categories->image) }}') no-repeat center center; background-size: cover; @endif ;">
                                </div>
