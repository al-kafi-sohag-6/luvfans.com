        ...
        <div class="col-lg-12">
            ...
            <div class="card shadow-custom border-0">
                <div class="card-body p-lg-5">
                    ...
                    <form method="post" action="{{ url('panel/admin/sub-categories/add') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <fieldset class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-switch form-switch-md">
                                    <input class="form-check-input" type="checkbox" name="search" checked="checked" value="on" role="switch">
                                </div>
                            </div>
                        </fieldset>
